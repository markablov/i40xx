    ...
    return (
      <>
        ...
        <div className="buttons">
          ...
          { showDebugButtons && <Button color="danger" onClick={Debugger.handleStop}>Stop</Button> }
          { showDebugButtons && (mode === 'debug') && <Button onClick={Debugger.handleStepOver}>Step over</Button> }
          { showDebugButtons && (mode === 'debug') && <Button onClick={Debugger.handleStepInto}>Step into</Button> }
          { showDebugButtons && (mode === 'debug') && <Button onClick={Debugger.handleContinue}>Continue</Button> }
        </div>
        <Columns>
